...
We developed an Android application to connect to the UAV via usb (radio signal module) or udp (simulated uav) in order to create a client order and make the UAV execute it autonomously and the user can visualize and supervise the operation.
