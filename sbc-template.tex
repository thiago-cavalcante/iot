...
As we show in Table~\ref{table:tests}, the production time in a real environment is a bit longer than in a simulation environment, due to external factors, such as wind and battery life.
